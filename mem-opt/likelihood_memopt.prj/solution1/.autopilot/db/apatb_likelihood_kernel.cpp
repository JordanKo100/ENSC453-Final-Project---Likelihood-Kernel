    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<512> > gmem4_pc_buffer(1);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 1; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_likelihood)[j*8+0] = gmem4_pc_buffer[i].range(63,0).to_int64();
((long long*)__xlx_apatb_param_likelihood)[j*8+1] = gmem4_pc_buffer[i].range(127,64).to_int64();
((long long*)__xlx_apatb_param_likelihood)[j*8+2] = gmem4_pc_buffer[i].range(191,128).to_int64();
((long long*)__xlx_apatb_param_likelihood)[j*8+3] = gmem4_pc_buffer[i].range(255,192).to_int64();
((long long*)__xlx_apatb_param_likelihood)[j*8+4] = gmem4_pc_buffer[i].range(319,256).to_int64();
((long long*)__xlx_apatb_param_likelihood)[j*8+5] = gmem4_pc_buffer[i].range(383,320).to_int64();
((long long*)__xlx_apatb_param_likelihood)[j*8+6] = gmem4_pc_buffer[i].range(447,384).to_int64();
((long long*)__xlx_apatb_param_likelihood)[j*8+7] = gmem4_pc_buffer[i].range(511,448).to_int64();
}}}
        } // end transaction
      } // end file is good
...
// print gmem0 Transactions
{
  ...
  {  __xlx_offset_byte_param_arrayX = 0*64;
  if (__xlx_apatb_param_arrayX) {
    for (int j = 0  - 0, e = 1 - 0; j != e; ++j) {
sc_bv<512> __xlx_tmp_lv;
__xlx_tmp_lv.range(63,0) = ((long long*)__xlx_apatb_param_arrayX)[j*8+0];
__xlx_tmp_lv.range(127,64) = ((long long*)__xlx_apatb_param_arrayX)[j*8+1];
__xlx_tmp_lv.range(191,128) = ((long long*)__xlx_apatb_param_arrayX)[j*8+2];
__xlx_tmp_lv.range(255,192) = ((long long*)__xlx_apatb_param_arrayX)[j*8+3];
__xlx_tmp_lv.range(319,256) = ((long long*)__xlx_apatb_param_arrayX)[j*8+4];
__xlx_tmp_lv.range(383,320) = ((long long*)__xlx_apatb_param_arrayX)[j*8+5];
__xlx_tmp_lv.range(447,384) = ((long long*)__xlx_apatb_param_arrayX)[j*8+6];
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_arrayX)[j*8+7];
...
// print gmem1 Transactions
{
  ...
  {  __xlx_offset_byte_param_arrayY = 0*64;
  if (__xlx_apatb_param_arrayY) {
    for (int j = 0  - 0, e = 1 - 0; j != e; ++j) {
sc_bv<512> __xlx_tmp_lv;
__xlx_tmp_lv.range(63,0) = ((long long*)__xlx_apatb_param_arrayY)[j*8+0];
__xlx_tmp_lv.range(127,64) = ((long long*)__xlx_apatb_param_arrayY)[j*8+1];
__xlx_tmp_lv.range(191,128) = ((long long*)__xlx_apatb_param_arrayY)[j*8+2];
__xlx_tmp_lv.range(255,192) = ((long long*)__xlx_apatb_param_arrayY)[j*8+3];
__xlx_tmp_lv.range(319,256) = ((long long*)__xlx_apatb_param_arrayY)[j*8+4];
__xlx_tmp_lv.range(383,320) = ((long long*)__xlx_apatb_param_arrayY)[j*8+5];
__xlx_tmp_lv.range(447,384) = ((long long*)__xlx_apatb_param_arrayY)[j*8+6];
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_arrayY)[j*8+7];
...
// print gmem4 Transactions
{
  ...
  {  __xlx_offset_byte_param_likelihood = 0*64;
  if (__xlx_apatb_param_likelihood) {
    for (int j = 0  - 0, e = 1 - 0; j != e; ++j) {
sc_bv<512> __xlx_tmp_lv;
__xlx_tmp_lv.range(63,0) = ((long long*)__xlx_apatb_param_likelihood)[j*8+0];
__xlx_tmp_lv.range(127,64) = ((long long*)__xlx_apatb_param_likelihood)[j*8+1];
__xlx_tmp_lv.range(191,128) = ((long long*)__xlx_apatb_param_likelihood)[j*8+2];
__xlx_tmp_lv.range(255,192) = ((long long*)__xlx_apatb_param_likelihood)[j*8+3];
__xlx_tmp_lv.range(319,256) = ((long long*)__xlx_apatb_param_likelihood)[j*8+4];
__xlx_tmp_lv.range(383,320) = ((long long*)__xlx_apatb_param_likelihood)[j*8+5];
__xlx_tmp_lv.range(447,384) = ((long long*)__xlx_apatb_param_likelihood)[j*8+6];
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_likelihood)[j*8+7];

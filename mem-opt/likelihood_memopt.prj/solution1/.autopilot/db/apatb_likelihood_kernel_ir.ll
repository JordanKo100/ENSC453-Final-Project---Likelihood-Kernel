; ModuleID = '/local-scratch/localhome/rkk10/Downloads/proj_7/proj_7/mem-opt/likelihood_memopt.prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_likelihood_kernel_ir(i32 %Nparticles, i32 %countOnes, i32 %IszY, i32 %Nfr, i32 %k, i64 %max_size, %struct.ap_uint* %arrayX, %struct.ap_uint* %arrayY, double* %objxy, i32* %I, %struct.ap_uint* %likelihood) local_unnamed_addr #0 {
entry:
  %arrayX_copy1 = alloca %struct.ap_uint, align 512
  %arrayY_copy2 = alloca %struct.ap_uint, align 512
  %objxy_copy = alloca double, align 512
  %I_copy = alloca i32, align 512
  %likelihood_copy3 = alloca %struct.ap_uint, align 512
  call fastcc void @copy_in(%struct.ap_uint* %arrayX, %struct.ap_uint* nonnull align 512 %arrayX_copy1, %struct.ap_uint* %arrayY, %struct.ap_uint* nonnull align 512 %arrayY_copy2, double* %objxy, double* nonnull align 512 %objxy_copy, i32* %I, i32* nonnull align 512 %I_copy, %struct.ap_uint* %likelihood, %struct.ap_uint* nonnull align 512 %likelihood_copy3)
  call void @apatb_likelihood_kernel_hw(i32 %Nparticles, i32 %countOnes, i32 %IszY, i32 %Nfr, i32 %k, i64 %max_size, %struct.ap_uint* %arrayX_copy1, %struct.ap_uint* %arrayY_copy2, double* %objxy_copy, i32* %I_copy, %struct.ap_uint* %likelihood_copy3)
  call fastcc void @copy_out(%struct.ap_uint* %arrayX, %struct.ap_uint* nonnull align 512 %arrayX_copy1, %struct.ap_uint* %arrayY, %struct.ap_uint* nonnull align 512 %arrayY_copy2, double* %objxy, double* nonnull align 512 %objxy_copy, i32* %I, i32* nonnull align 512 %I_copy, %struct.ap_uint* %likelihood, %struct.ap_uint* nonnull align 512 %likelihood_copy3)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%struct.ap_uint*, %struct.ap_uint* noalias align 512, %struct.ap_uint*, %struct.ap_uint* noalias align 512, double* readonly, double* noalias align 512, i32* readonly, i32* noalias align 512, %struct.ap_uint*, %struct.ap_uint* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0f64(double* noalias align 512, double* noalias readonly) unnamed_addr #5 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%struct.ap_uint*, %struct.ap_uint* noalias align 512, %struct.ap_uint*, %struct.ap_uint* noalias align 512, double*, double* noalias readonly align 512, i32*, i32* noalias readonly align 512, %struct.ap_uint*, %struct.ap_uint* noalias align 512) unnamed_addr #6 {
entry:
...
declare void @apatb_likelihood_kernel_hw(i32, i32, i32, i32, i32, i64, %struct.ap_uint*, %struct.ap_uint*, double*, i32*, %struct.ap_uint*)

define void @likelihood_kernel_hw_stub_wrapper(i32, i32, i32, i32, i32, i64, %struct.ap_uint*, %struct.ap_uint*, double*, i32*, %struct.ap_uint*) #7 {
entry:
  call void @copy_out(%struct.ap_uint* null, %struct.ap_uint* %6, %struct.ap_uint* null, %struct.ap_uint* %7, double* null, double* %8, i32* null, i32* %9, %struct.ap_uint* null, %struct.ap_uint* %10)
  call void @likelihood_kernel_hw_stub(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i64 %5, %struct.ap_uint* %6, %struct.ap_uint* %7, double* %8, i32* %9, %struct.ap_uint* %10)
  call void @copy_in(%struct.ap_uint* null, %struct.ap_uint* %6, %struct.ap_uint* null, %struct.ap_uint* %7, double* null, double* %8, i32* null, i32* %9, %struct.ap_uint* null, %struct.ap_uint* %10)
  ret void
}

declare void @likelihood_kernel_hw_stub(i32, i32, i32, i32, i32, i64, %struct.ap_uint*, %struct.ap_uint*, double*, i32*, %struct.ap_uint*)

...
architecture rtl of likelihood_kernel_buffer_objxy_ram is 
...
architecture arch of likelihood_kernel_buffer_objxy is
    component likelihood_kernel_buffer_objxy_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    likelihood_kernel_buffer_objxy_ram_U :  component likelihood_kernel_buffer_objxy_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

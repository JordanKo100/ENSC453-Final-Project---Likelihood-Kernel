...
void load_objxy(const double* objxy,
    ...
    loadObjxy: for (int i = 0; i < total_doubles; i++) {
        ...
        #pragma HLS LOOP_TRIPCOUNT min=2 max=60
...
#pragma HLS ARRAY_PARTITION variable=buffer_pixels cyclic factor=25 dim=2 
